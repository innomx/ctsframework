...
directory named `r paste0(cts_results_path, "Base Scenario")` which contains
the specified outputs each in their own subfolder corresponding to the name of
the module where it was specified. For instance, the subfolder named
`summarization` contains these 2 plots:
